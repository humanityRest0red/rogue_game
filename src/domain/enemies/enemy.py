...
from domain.setting import ENEMY_HEALTH_MIN, ENEMY_HEALTH_MAX, ENEMY_AGILITY_MIN, ENEMY_AGILITY_MAX, ENEMY_STRENGTH_MIN, ENEMY_STRENGTH_MAX, ENEMY_HOSTILITY_MIN, ENEMY_HOSTILITY_MAX
...
class Enemy:
    ...
    def pattern_move(self, room, step=1):
