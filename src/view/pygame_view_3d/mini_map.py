...
from view.pygame_view_3d.settings import WIDTH_SCREEN, HEIGHT_SCREEN, MINI_MAP_COEF
from view.pygame_view_3d.settings import BLACK, BROWN, WHITE, RED, GREEN, BLUE, YELLOW
